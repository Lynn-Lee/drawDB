...
5. 画布组件 memo 和选择器优化。（Phase 4.7 已完成第一层 render layer memo 基线，稳定 table、area、note、relationship props，后续继续做拖拽中间态隔离。）
6. 大图 benchmark。
7. 评估视口裁剪或 SVG 分层。
