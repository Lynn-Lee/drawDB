...
const zh = {
  translation: {
    ...
    landing_feature_shortcuts_body: "使用键盘快捷键加速开发，几乎所有操作都有对应快捷键。",
    ...
    not_found_check_out: "欢迎在",
    not_found_github_issues: "GitHub 提交 issue 告诉我们",
    ...
    migration_not_supported_generic: "通用图表不支持生成迁移。",
    ...
    custom_types_description:
      "定义默认不支持的自定义数据类型。创建或编辑列时可以使用这些类型。",
    type_data_corrupted: "已配置的类型数据已损坏。",
    no_custom_types: "尚未配置任何类型",
    close: "关闭",
    ...
    force_hide: "强制隐藏",
    owner: "所有者",
    local_this_browser: "本地（当前浏览器）",
    navbar_features: "功能",
    navbar_editor: "编辑器",
    jump_to_github: "跳转到 GitHub",
    open_navigation_menu: "打开导航菜单",
    new_diagram_wizard_eyebrow: "本地优先编辑器",
    new_diagram_wizard_title: "创建本地图表",
    new_diagram_wizard_description: "默认只保存在当前浏览器中。",
    new_diagram_database_generic_description:
      "不绑定特定数据库方言约束的通用图表。",
    new_diagram_database_mysql_description:
      "使用面向 MySQL 的类型和默认导出设置。",
    new_diagram_database_postgres_description:
      "使用 PostgreSQL 类型、枚举和数组。",
    new_diagram_database_sqlite_description:
      "使用适合 SQLite 的 schema 默认设置。",
    new_diagram_database_mariadb_description:
      "使用面向 MariaDB 的类型和默认导出设置。",
    new_diagram_database_mssql_description:
      "使用面向 SQL Server 的 schema 默认设置。",
    new_diagram_database_oracle_description:
      "使用面向 Oracle 的 schema 默认设置。",
    create_blank_diagram: "创建空白图表",
    start_from_template: "从模板开始",
    import_sql_dbml_json: "导入 SQL、DBML 或 JSON",
    small_screen_editor_mode: "小屏编辑模式",
    small_screen_editor_description:
      "完整画布编辑建议使用平板或桌面设备。导入、导出、保存和打开仍可通过顶部菜单使用。",
  },
};
